...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (errorParam === 'AccessDenied') {
      setError('Accès refusé : Votre email n\'est pas autorisé à accéder au CRM.');
    }
  }, [router, searchParams]);
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Connectez-vous pour accéder au système de gestion des prospects
          </p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500">
              Seuls les comptes autorisés peuvent accéder au CRM.<br />
              Contactez l'administrateur si vous avez des problèmes d'accès.
            </p>
          </div>
        </div>
      </div>
